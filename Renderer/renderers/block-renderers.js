...
(function (global) {
    ...
    const I18N = Object.freeze({
        en:{summary:'Executive Summary',metrics:'Key Metrics',insights:'Insights',decisions:'Decisions',risks:'Risks',tasks:'Tasks',architecture:'Architecture & Process',owners:'Owners',task:'Task',owner:'Owner',dueDate:'Due Date',participants:'Participants',generated:'Generated by MeetMind AI',meetingReport:'Meeting Report',minuteShort:'min'},
        ru:{summary:'Резюме встречи',metrics:'Ключевые метрики',insights:'Инсайты',decisions:'Решения',risks:'Риски',tasks:'Задачи',architecture:'Архитектура и процесс',owners:'Владельцы',task:'Задача',owner:'Владелец',dueDate:'Срок',participants:'Участники',generated:'Создано MeetMind AI',meetingReport:'Отчёт о встрече',minuteShort:'мин'},
        es:{summary:'Resumen ejecutivo',metrics:'Métricas clave',insights:'Hallazgos',decisions:'Decisiones',risks:'Riesgos',tasks:'Tareas',architecture:'Arquitectura y proceso',owners:'Responsables',task:'Tarea',owner:'Responsable',dueDate:'Fecha límite',participants:'Participantes',generated:'Generado por MeetMind AI',meetingReport:'Informe de la reunión',minuteShort:'min'},
        pt:{summary:'Resumo executivo',metrics:'Métricas-chave',insights:'Insights',decisions:'Decisões',risks:'Riscos',tasks:'Tarefas',architecture:'Arquitetura e processo',owners:'Responsáveis',task:'Tarefa',owner:'Responsável',dueDate:'Prazo',participants:'Participantes',generated:'Gerado pelo MeetMind AI',meetingReport:'Relatório da reunião',minuteShort:'min'},
        tr:{summary:'Yönetici Özeti',metrics:'Temel Metrikler',insights:'İçgörüler',decisions:'Kararlar',risks:'Riskler',tasks:'Görevler',architecture:'Mimari ve Süreç',owners:'Sorumlular',task:'Görev',owner:'Sorumlu',dueDate:'Son Tarih',participants:'Katılımcılar',generated:'MeetMind AI tarafından oluşturuldu',meetingReport:'Toplantı Raporu',minuteShort:'dk'},
        id:{summary:'Ringkasan Eksekutif',metrics:'Metrik Utama',insights:'Insight',decisions:'Keputusan',risks:'Risiko',tasks:'Tugas',architecture:'Arsitektur & Proses',owners:'Penanggung Jawab',task:'Tugas',owner:'Penanggung Jawab',dueDate:'Tenggat',participants:'Peserta',generated:'Dibuat oleh MeetMind AI',meetingReport:'Laporan Rapat',minuteShort:'mnt'},
        hi:{summary:'एग्जीक्यूटिव सारांश',metrics:'मुख्य मेट्रिक्स',insights:'इनसाइट्स',decisions:'निर्णय',risks:'जोखिम',tasks:'कार्य',architecture:'आर्किटेक्चर और प्रक्रिया',owners:'जिम्मेदार',task:'कार्य',owner:'जिम्मेदार',dueDate:'अंतिम तिथि',participants:'प्रतिभागी',generated:'MeetMind AI द्वारा बनाया गया',meetingReport:'मीटिंग रिपोर्ट',minuteShort:'मिनट'},
        ar:{summary:'الملخص التنفيذي',metrics:'المؤشرات الرئيسية',insights:'الرؤى',decisions:'القرارات',risks:'المخاطر',tasks:'المهام',architecture:'البنية والعملية',owners:'المسؤولون',task:'المهمة',owner:'المسؤول',dueDate:'الموعد النهائي',participants:'المشاركون',generated:'تم إنشاؤه بواسطة MeetMind AI',meetingReport:'تقرير الاجتماع',minuteShort:'دقيقة'},
        uz:{summary:'Ijrochi xulosa',metrics:'Asosiy ko‘rsatkichlar',insights:'Tahlillar',decisions:'Qarorlar',risks:'Xatarlar',tasks:'Vazifalar',architecture:'Arxitektura va jarayon',owners:'Mas’ullar',task:'Vazifa',owner:'Mas’ul',dueDate:'Muddat',participants:'Ishtirokchilar',generated:'MeetMind AI tomonidan yaratildi',meetingReport:'Uchrashuv hisoboti',minuteShort:'daq'},
        fa:{summary:'خلاصه مدیریتی',metrics:'شاخص‌های کلیدی',insights:'بینش‌ها',decisions:'تصمیم‌ها',risks:'ریسک‌ها',tasks:'وظایف',architecture:'معماری و فرایند',owners:'مسئولان',task:'وظیفه',owner:'مسئول',dueDate:'مهلت',participants:'شرکت‌کنندگان',generated:'ایجادشده توسط MeetMind AI',meetingReport:'گزارش جلسه',minuteShort:'دقیقه'}
    });
