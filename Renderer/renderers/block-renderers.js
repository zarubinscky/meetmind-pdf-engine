...
(function (global) {
    ...
    const I18N = Object.freeze({
        en:{summary:'Executive Summary',metrics:'Key Metrics',insights:'Insights',decisions:'Decisions',risks:'Risks',tasks:'Tasks',architecture:'Architecture & Process',owners:'Owners',task:'Task',owner:'Owner',dueDate:'Due Date'},
        ru:{summary:'Резюме встречи',metrics:'Ключевые метрики',insights:'Инсайты',decisions:'Решения',risks:'Риски',tasks:'Задачи',architecture:'Архитектура и процесс',owners:'Владельцы',task:'Задача',owner:'Владелец',dueDate:'Срок'},
        es:{summary:'Resumen ejecutivo',metrics:'Métricas clave',insights:'Hallazgos',decisions:'Decisiones',risks:'Riesgos',tasks:'Tareas',architecture:'Arquitectura y proceso',owners:'Responsables',task:'Tarea',owner:'Responsable',dueDate:'Fecha límite'},
        pt:{summary:'Resumo executivo',metrics:'Métricas-chave',insights:'Insights',decisions:'Decisões',risks:'Riscos',tasks:'Tarefas',architecture:'Arquitetura e processo',owners:'Responsáveis',task:'Tarefa',owner:'Responsável',dueDate:'Prazo'}
    });
    function lang(ctx){
